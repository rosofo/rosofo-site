...
void main() {
    ...
    vec4 newP2 = set(202, vec4(vec2(100, 50.0), 0.0, 0.0));
    ...
    if(texelCoord(gl_FragCoord).y > 10) {
        ...
        gl_FragColor = debugColor(0, x) + debugColor(1, started) + debugColor(2, vec4(p2, 0.0, 1.0)) + debugColor(3, vec4(u_p1, 0.0, 1.0));
    } else {
